        ...
        VerticalPager(
            ...
            if (video != null) {
                VideoItem(
                    ...
                    onLikeClick = { viewModel.onEvent(HomeFeedViewModelEvent.ToggleLike(video.id)) },
                    onCommentClick = {
                        showCommentsForVideoId = video.id
                        viewModel.onEvent(HomeFeedViewModelEvent.LoadComments(video.id))
                    },
            ...
            CommentsBottomSheet(
                ...
                onPostComment = { content ->
                    showCommentsForVideoId?.let { videoId ->
                        viewModel.onEvent(HomeFeedViewModelEvent.PostComment(videoId, content))
                    }
                }
            )
        }
